...
<div style="display: flex; flex-direction: column; gap: 20px;">
    ...
    <div class="settings-tabs-nav" style="display: flex; gap: 8px; background: var(--ula-surface-card); padding: 8px; border-radius: var(--ula-radius-xl); border: 1px solid var(--ula-border-subtle); box-shadow: var(--ula-shadow-sm); overflow-x: auto;">
    ...
    <div id="sa-tab-content-general" class="sa-tab-pane" style="display: block;">
        <form method="POST" action="{{ route('superadmin.settings.update') }}">
            ...
            <div class="panel-card" style="background: var(--ula-surface-card); border: 1px solid var(--ula-border-subtle); border-radius: var(--ula-radius-xl); padding: 28px; box-shadow: var(--ula-shadow-sm);">
                ...
                <div style="margin-top: 24px; display: flex; justify-content: flex-end;">
                    <button type="submit" class="tactile-btn btn-primary" style="padding: 12px 28px; font-size: 13px; border-radius: var(--ula-radius-pill); display: inline-flex; align-items: center; gap: 6px;">
            ...
            <div class="panel-card" style="background: var(--ula-surface-card); border: 1px solid var(--ula-border-subtle); border-radius: var(--ula-radius-xl); padding: 28px; box-shadow: var(--ula-shadow-sm);">
                ...
                <div style="margin-bottom: 24px;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px;">
                        <div>
                            <label style="display: block; font-size: 11px; font-weight: 700; color: var(--ula-text-secondary); margin-bottom: 6px;">1 USD <span class="material-symbols-rounded" style="font-size: 1em; vertical-align: text-bottom;">arrow_forward</span> {{ __('SAR') }}</label>
                        ...
                        <div>
                            <label style="display: block; font-size: 11px; font-weight: 700; color: var(--ula-text-secondary); margin-bottom: 6px;">1 USD <span class="material-symbols-rounded" style="font-size: 1em; vertical-align: text-bottom;">arrow_forward</span> {{ __('EGP') }}</label>
                        ...
                        <div>
                            <label style="display: block; font-size: 11px; font-weight: 700; color: var(--ula-text-secondary); margin-bottom: 6px;">1 USD <span class="material-symbols-rounded" style="font-size: 1em; vertical-align: text-bottom;">arrow_forward</span> {{ __('AED') }}</label>
                ...
                <div style="margin-bottom: 24px; padding-top: 16px; border-top: 1px solid var(--ula-border-subtle);">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; flex-wrap: wrap; gap: 8px;">
                        ...
                        <button type="button" onclick="addBankAccountRow()" class="tactile-btn btn-secondary" style="padding: 6px 14px; font-size: 12px; border-radius: var(--ula-radius-pill); display: inline-flex; align-items: center; gap: 4px;">
                ...
                <div style="margin-top: 24px; display: flex; justify-content: flex-end;">
                    <button type="submit" class="tactile-btn btn-primary" style="padding: 12px 32px; font-size: 13px; border-radius: var(--ula-radius-pill); display: inline-flex; align-items: center; gap: 6px;">
                        <span class="material-symbols-rounded" style="font-size: 16px;">save</span>
            ...
            <div class="panel-card" style="background: var(--ula-surface-card); border: 1px solid var(--ula-border-subtle); border-radius: var(--ula-radius-xl); padding: 28px; box-shadow: var(--ula-shadow-sm);">
                ...
                <div style="display: flex; flex-direction: column; gap: 16px; background: var(--ula-surface-page-alt); border: 1px solid var(--ula-border-subtle); border-radius: 14px; padding: 20px;">
                    ...
                    <div style="display: flex; justify-content: flex-end; margin-top: 8px;">
                        <button type="submit" class="tactile-btn btn-primary" style="padding: 10px 22px; font-size: 12px; border-radius: var(--ula-radius-pill); display: inline-flex; align-items: center; gap: 6px;">
