                ...
                <tbody>
                    @foreach($members as $m)
                        ...
                        <tr style="border-bottom: 1px solid var(--ula-border-subtle);">
                            ...
                            <td style="padding: 14px 16px; font-weight: var(--ula-weight-bold); font-family: var(--ula-font-mono); font-size: var(--ula-size-sm); color: var(--ula-text-primary);">{{ $capacity }}h / wk</td>
                            <td style="padding: 14px 16px; font-weight: var(--ula-weight-bold); font-family: var(--ula-font-mono); font-size: var(--ula-size-sm); color: var(--ula-text-primary);">{{ $memberTasks->count() }} {{ __('active') }}</td>
