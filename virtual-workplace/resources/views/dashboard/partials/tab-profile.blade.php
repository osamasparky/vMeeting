<div id="tab-profile" class="tab-view">
    ...
    <div class="card" style="margin-bottom: var(--ula-space-7, 24px); border-radius: var(--ula-radius-xl, 20px); padding: 24px; border: 1px solid var(--ula-border-subtle); box-shadow: var(--ula-shadow-sm); background: var(--ula-surface-card); position: relative; overflow: hidden;">
        <div style="display: flex; align-items: center; gap: 24px; flex-wrap: wrap;">
            ...
            <div style="position: relative; width: 92px; height: 92px; border-radius: var(--ula-radius-xl, 24px); overflow: hidden; box-shadow: var(--ula-shadow-md); border: 2.5px solid var(--ula-palm-700, #1E412F); background: var(--ula-palm-900, #142B24); flex-shrink: 0;">
                ...
                <div id="user-profile-avatar-fallback" style="width: 100%; height: 100%; display: {{ $user->avatar_url ? 'none' : 'flex' }}; align-items: center; justify-content: center; font-size: 32px; font-weight: 800; color: var(--ula-sand-100, #f9f6ef); font-family: var(--ula-font-mono);">
            ...
            <div style="flex: 1; min-width: 240px;">
                <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                    ...
                    @endif
                    <span class="nav-badge-pill" style="background: rgba(30, 65, 47, 0.1); color: var(--ula-palm-700, #1E412F); font-size: 11px; font-weight: 700;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(360px, 1fr)); gap: 24px; margin-bottom: 24px;">
        ...
        <div class="card" style="margin-bottom: 0; border-radius: var(--ula-radius-xl, 20px); padding: 24px; background: var(--ula-surface-card); border: 1px solid var(--ula-border-subtle); box-shadow: var(--ula-shadow-sm);">
            <h3 style="font-size: 16px; font-weight: 800; color: var(--ula-text-primary); margin-bottom: 20px; display: flex; align-items: center; gap: 8px; padding-bottom: 12px; border-bottom: 1px solid var(--ula-border-subtle);">
                <span class="material-symbols-rounded" style="font-size: 20px; color: var(--ula-palm-700, #1E412F);">badge</span>
            ...
            <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 18px;">
                ...
                <div>
                    <label style="display: block; font-size: 12px; font-weight: 700; color: var(--ula-text-secondary); margin-bottom: 6px;">
                        {{ __('Full Name') }} <span style="color: var(--ula-status-danger, #9A5827);">*</span>
                    </label>
                    <input type="text" name="name" required value="{{ old('name', $user->name) }}" class="form-input" style="width: 100%; background: var(--ula-sand-100, #f9f6ef); border: 1px solid var(--ula-border-subtle); border-radius: var(--ula-radius-md, 12px); padding: 10px 14px; color: var(--ula-text-primary); font-size: 13px; font-weight: 600; outline: none; text-align: start;">
                </div>
                ...
                <div>
                    <label style="display: flex; align-items: center; gap: 5px; font-size: 12px; font-weight: 700; color: var(--ula-text-secondary); margin-bottom: 6px;">
                        <span class="material-symbols-rounded" style="font-size: 16px; color: var(--ula-text-muted);">mail</span>
                        <span>{{ __('Email Address') }}</span> <span style="color: var(--ula-status-danger, #9A5827);">*</span>
                    </label>
                ...
                <div style="display: grid; grid-template-columns: 1.3fr 1fr; gap: 14px;">
                    ...
                    <div>
                        ...
                        <select name="work_mode" class="form-input" style="width: 100%; background: var(--ula-sand-100, #f9f6ef); border: 1px solid var(--ula-border-subtle); border-radius: var(--ula-radius-md, 12px); padding: 10px 14px; color: var(--ula-text-primary); font-size: 12px; font-weight: 600; outline: none;">
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            ...
            <div class="card" style="margin-bottom: 0; border-radius: var(--ula-radius-xl, 20px); padding: 24px; background: var(--ula-surface-card); border: 1px solid var(--ula-border-subtle); box-shadow: var(--ula-shadow-sm);">
                <h3 style="font-size: 16px; font-weight: 800; color: var(--ula-text-primary); margin-bottom: 20px; display: flex; align-items: center; gap: 8px; padding-bottom: 12px; border-bottom: 1px solid var(--ula-border-subtle);">
                    <span class="material-symbols-rounded" style="font-size: 20px; color: var(--ula-palm-700, #1E412F);">interests</span>
            ...
            <div class="card" style="margin-bottom: 0; border-radius: var(--ula-radius-xl, 20px); padding: 24px; background: var(--ula-surface-card); border: 1px solid var(--ula-border-subtle); box-shadow: var(--ula-shadow-sm);">
                <h3 style="font-size: 16px; font-weight: 800; color: var(--ula-text-primary); margin-bottom: 20px; display: flex; align-items: center; gap: 8px; padding-bottom: 12px; border-bottom: 1px solid var(--ula-border-subtle);">
                    <span class="material-symbols-rounded" style="font-size: 20px; color: var(--ula-palm-700, #1E412F);">lock</span>
                ...
                <form method="POST" action="{{ route('profile.password.update') }}" style="display: flex; flex-direction: column; gap: 18px;">
                    ...
                    <div>
                        ...
                        <input type="password" name="current_password" required placeholder="••••••••" class="form-input" style="width: 100%; background: var(--ula-sand-100, #f9f6ef); border: 1px solid var(--ula-border-subtle); border-radius: var(--ula-radius-md, 12px); padding: 10px 14px; color: var(--ula-text-primary); font-size: 13px; outline: none; text-align: start;">
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 14px;">
                        <div>
                            ...
                            <input type="password" name="password" required placeholder="Min 8 chars" class="form-input" style="width: 100%; background: var(--ula-sand-100, #f9f6ef); border: 1px solid var(--ula-border-subtle); border-radius: var(--ula-radius-md, 12px); padding: 10px 14px; color: var(--ula-text-primary); font-size: 13px; outline: none; text-align: start;">
                        </div>
                        <div>
                            <label style="display: flex; align-items: center; gap: 5px; font-size: 12px; font-weight: 700; color: var(--ula-text-secondary); margin-bottom: 6px;">
